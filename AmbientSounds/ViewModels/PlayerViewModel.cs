...
namespace AmbientSounds.ViewModels
{
    ...
    public class PlayerViewModel : ObservableObject
    {
        ...
        public bool IsPlaying
        {
            get
            {
                return _player.PlaybackState == MediaPlaybackState.Playing || _player.PlaybackState == MediaPlaybackState.Opening;
            }
        }
        ...
        public string SoundName
        {
            get
            {
                return _player?.Current?.Name ?? _player?.Current?.Id ?? "None";
            }
        }
